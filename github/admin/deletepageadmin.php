...
<p>Нажмите на эту кнопку для удаления страницы</p>

<a href="delete.php"><button type="submit"  onclick="myFunction()">Удалить</button></a>
<a href="editpageadmin.php"><button type="button">Назад</button></a>
 <a href="adminlogin.php"><button>Выйти</button></a>
