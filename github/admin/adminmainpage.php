	...
	<div class="container center-div shadow">
  		 ...
  		 <center><b>ADMIN INPUT PAGE</b></center>
	        ...
	        <div class="form-group">
   			...
   			<a href = "logout.php"class="btn btn-danger">Выйти</a><br><br>
   			<a href = "editpageadmin.php"class="btn btn-primary">Другая информация</a>
   			<a href = "allnotice.php"class="btn btn-primary">Уведомления</a>
   			<a href = "noticeboardadd.php"class="btn btn-primary">Добавить уведомление</a>
